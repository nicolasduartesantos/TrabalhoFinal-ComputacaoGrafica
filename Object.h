...
public:
    ...
    virtual Color* getRGB(std::vector<Light*> lights, std::vector<Object*> objects, Vector* p0, Vector* dir, Light* environmentLight) = 0;

    bool hasShadow(std::vector<Object*> objects, Vector* pi, Vector l, Light* light);

    Color* RGBtoPaint(std::vector<Light*> lights, std::vector<Object*> objects, Vector* p0, Vector* dir, Light* environmentLight, Vector* normal, Object* obj);
